...
Naturally, the exact factor varies between use-cases, but for the purpose of our analysis of determining what conditions can lead to failures, we choose a safety factor of an order of magnitude (\safetyMargin) over the baseline to be conservative, although actual deployments may require additional margin\todo{self-contradictory}.
...
\todo{Needs rephrasing for clarity.}
