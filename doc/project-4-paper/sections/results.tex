        ...
        \end{scope}
            ...
            \foreach \system in {rpi-4,rpi-5,petalinux,tk-1}{
                \foreach  \vendor  in {ptpd,linuxptp,sptp,chrony}{
                    ...
                    \node[on chain] {\fTimeKey[1]{base/\system/\vendor/q95}};
                    \node[on chain] {\fTimeKey[0]{base/\system/\vendor/q100}};
                    \end{scope}
                }
            }
    \end{tikzpicture}
