...
\begin{figure}
    \includegraphics[width=\linewidth]{res/generated/isolation_comparison.pdf}
    \caption{Different possibilities of isolation network load, compared to the baseline with no load.}
...
Compared to no traffic prioritization, activating DSCP results in performance improvements of \fRatio[1]{\cmpMin} to \fRatio{\cmpMax} (\fVendor{\cmpMinArg} and \fVendor{\cmpMaxArg}, respectively). \todo{Resume when data available.}