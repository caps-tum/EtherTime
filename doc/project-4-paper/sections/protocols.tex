...
Since we are interested in evaluating time synchronization for
...
IEEE Time Sensitive Networking~\cite{stanton2018distributing}.
...
%\todo{@arpan: cited as personal communication: submitted via email because no public issue tracker is available}
...
\textbf{(d)}~Finally, we include Chrony~\cite{dinar2020ntp}, the state-of-the-art NTP implementation.
%as a reference.
