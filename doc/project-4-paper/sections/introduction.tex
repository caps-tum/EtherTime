...
%science (telescopes, large hadron colliders and
%radar~\cite{white-rabbit-astrophysics,white-rabbit-at-cern,
%time-synchronization-radar}) and industry (automotive and factory
%floor~\cite{time-synchronization-automotive,time-synchronization-factory-floor})
%all relying on it.
