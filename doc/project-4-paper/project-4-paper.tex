...
Our results show that critical challenges---including resource contention
(specifically network and memory, CPU is less significant) and faults of
various kinds (with/without hardware clock support)---still need to be
addressed %by careful configuration and testing
before high-precision network time can truly be~relied~upon.
